 ...
 * ورودی‌ها: ندارد.
 * رفتار: داده‌های نمونه پروژه را بدون تغییر وضعیت واقعی نمایش می‌دهد.
 */
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
        ...
        <button className="flex items-center justify-center gap-2 bg-[#006039] text-white px-5 py-2 rounded-lg text-sm font-bold hover:bg-[#004d2e] transition-colors shadow-sm w-full sm:w-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {PROJECTS_DATA.map((project) => (
          ...
          >
            <div className={`h-32 bg-gradient-to-br ${project.color} relative p-5 flex flex-col justify-between`}>
            ...
            <div className="p-5 flex-1 flex flex-col justify-between space-y-5">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-[#fefce8]/50 rounded-lg p-3 border border-[#c9a656]/20">
                  ...
                  <div className="text-xs font-bold text-[#c9a656]">{project.basePrice}</div>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between items-center mt-3 pt-3 border-t border-gray-100">
                  ...
                  <div className="text-sm font-black text-gray-900">
                    <span className="text-emerald-600">{project.availableUnits}</span>
